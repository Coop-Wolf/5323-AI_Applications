...
[Multi-Armed Bandits in Recommendation Systems](Link)
...
simulation and TaoBao searchengine. Theresultsdemonstratethat
our algorithm performs much better than the state-of-the-art LTR
methods, with more than %and %growthoftotaltransaction
